          ...
          <div className="lg:col-span-5 relative" id="hero-metrics">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4">
                {stats.map((stat, i) => (
                  <div key={i} className="p-4 bg-navy-900 border border-slate-800/80 rounded-2xl relative group hover:border-gold-500/30 transition-all text-left">
                    <span className="block font-mono text-[20px] font-extrabold text-gold-500 tracking-tight leading-none mb-1 group-hover:scale-105 transition-transform origin-left">
                      {stat.metric}
                    </span>
